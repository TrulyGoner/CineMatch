export const buildEngagementData = (events) => {
...
export const buildGenreHeatmap = (events) => {
...
export const calculatePersonalizationScore = (events, recommendations) => {
    ...
    if (topGenres.length === 0)
        return 35;
    const matched = recommendations.filter((rec) => rec.genres.some((g) => topGenres.includes(g))).length;
